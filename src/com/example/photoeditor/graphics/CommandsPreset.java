...
import com.example.photoeditor.graphics.commands.BlackFrameCommand;
import com.example.photoeditor.graphics.commands.ColorBoostCommand;
import com.example.photoeditor.graphics.commands.ColorFilterCommand;
import com.example.photoeditor.graphics.commands.DecreaseColorDepthCommand;
import com.example.photoeditor.graphics.commands.EmbossCommand;
import com.example.photoeditor.graphics.commands.EmptyCommand;
import com.example.photoeditor.graphics.commands.GammaCorrectionCommand;
import com.example.photoeditor.graphics.commands.GaussianBlurCommand;
import com.example.photoeditor.graphics.commands.GrayscaleCommand;
import com.example.photoeditor.graphics.commands.ImageProcessingCommand;
import com.example.photoeditor.graphics.commands.InvertColorCommand;
import com.example.photoeditor.graphics.commands.MirrorCommand;
import com.example.photoeditor.graphics.commands.SepiaCommand;
import com.example.photoeditor.graphics.commands.SharpenCommand;
import com.example.photoeditor.graphics.commands.TintCommand;
